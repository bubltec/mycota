...
// path — kept in the same union since it's still "how this user proved who
// they are."
...
export interface ProfessionalVerification {
  ...
  domain: string;
  /** An AI's guess at the org type, e.g. "veterinary_clinic" — a signal for the human reviewer, not a gate. */
